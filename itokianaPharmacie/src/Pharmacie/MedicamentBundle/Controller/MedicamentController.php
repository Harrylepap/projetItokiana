...
class MedicamentController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Pharmacie\MedicamentBundle\Form\MedicamentType', $medicament);
    ...
    {
        $deleteForm = $this->createDeleteForm($medicament);
        $editForm = $this->createForm('Pharmacie\MedicamentBundle\Form\MedicamentType', $medicament);
